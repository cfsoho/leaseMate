...
def create(payload: FinancialInstitutionCreate, _admin=Depends(require_admin), db: Session = Depends(get_db)):
...
def delete(
    ...
    deleted = delete_financial_institution(db, institution_id, current_user.id)
