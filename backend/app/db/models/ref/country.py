...
class Country(Base):
    ...
    # National mobile-phone display mask.
    #
    # Example:
    # JP -> XXX-XXXX-XXXX
    mobile_phone_format = Column(
        String(50),
        nullable=True,
        comment="National mobile phone display format using X placeholders"
    )

    # National landline-phone display mask.
    #
    # Example:
    # JP -> XX-XXXX-XXXX
    landline_phone_format = Column(
        String(50),
        nullable=True,
        comment="National landline phone display format using X placeholders"
    )
